"""shared/ssm_names.py — the cross-stack SSM contract for agentic-cx-bank.
...
Names are plain ``String`` params under the ``/agentic-cx-bank/<phase>/<key>``
...
# lives OUTSIDE the /agentic-cx-bank namespace because CX-LANG-UTILS owns it;
