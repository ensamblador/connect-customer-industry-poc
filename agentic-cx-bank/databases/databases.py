"""
databases/databases.py — DynamoDB tables for the banco self-service backend.
...
Three tables back the API:
  ...
  * products  (PK productId)                          — banking product catalog
...
class Tables(Construct):
    """All DynamoDB tables for the banco-cx project (+ sample data)."""
