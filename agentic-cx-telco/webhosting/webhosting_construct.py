...
class Webhosting(Construct):
    ...
    def _create_data_viewer_origin(self) -> "origins.RestApiOrigin":
        ...
        The Lambda scans the three telco tables (accounts/plans/lines) and
        ...
        Phase 1 (CX-TELCO-MCP); deploy that stack first.
        """
        stack = Stack.of(self)
        table_names = [
        ...
        fn = _lambda.Function(
            ...
            description="Renders the telco demo DynamoDB tables as an HTML page.",
        )
        ...
        api = apigateway.LambdaRestApi(
            ...
            description="Demo data viewer for the telco DynamoDB tables.",
        )
    ...
    def _create_resources(self) -> None:
        ...
        CfnOutput(self, "WebsiteDataViewerPath",
                  ...
                  description="URL of the demo data viewer (accounts/plans/lines)")
