"""
agentic_cx_telco/website_stack.py — Phase 6: the static "Latam Telco" website.
...
construct. This stack is a thin wrapper: it reads the telco ``config`` and
...
(accounts/plans/lines) as HTML. Because that Lambda reads those tables at
runtime, the stack is ordered after CX-TELCO-MCP (ordering-only edge — the
