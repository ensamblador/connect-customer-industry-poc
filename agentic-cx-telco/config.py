...
deploy order (see app.py):
    ...
    Phase 1  CX-TELCO-MCP             McpStack
    Phase 2  CX-TELCO-KB              KnowledgeBaseStack
    Phase 3  CX-TELCO-CONNECT-SUPPORT ConnectSupportStack
    Phase 4  CX-TELCO-AGENTS          AiAgentsStack
    Phase 5  CX-TELCO-FLOWS           ContactFlowsStack
    Phase 6  CX-TELCO-WEBSITE         WebsiteStack
...
GATEWAY_NAME = "telco-mcp-server"

# DynamoDB tables backing the REST API / MCP tools.
ACCOUNTS_TABLE_NAME = "telco-accounts"
PLANS_TABLE_NAME = "telco-plans"
LINES_TABLE_NAME = "telco-lines"
...
AI_AGENT_MCP_TARGET = "telco-rest-api-oas-target"
...
KB_ENTRIES_DIR = "knowledge_bases/telco/entries"
# Logical S3 path prefix for the uploaded entries (organizational only — the
# DataIntegration SourceURI is the whole bucket): telco/es/..., telco/pt/..., etc.
KB_BUCKET_PREFIX = "telco"

# ========================================================================== #
# PHASE 3 — CX-TELCO-CONNECT-SUPPORT (ConnectSupportStack)
# AI-agent security profiles + customer-managed views + eSIM guide flow + Lex bot.
# ========================================================================== #
...
#                            surfaced from a recommendation (the eSIM guide).
AI_AGENT_SECURITY_PROFILE_NAME = "telco-selfservice-ai-agent"
...
AI_AGENT_ASSIST_SECURITY_PROFILE_NAME = "telco-agent-assist-iac"
...
# The new-line guided form (AWS::Connect::View), rendered in the chat window by a
# "Show view" (ShowView) block; authored payload in views/<name>/view-content.json.
NEWLINE_VIEW_NAME = "TelcoNewLineForm"
NEWLINE_VIEW_CONTENT = "views/telco-newline-form/view-content.json"

# --- eSIM activation step-by-step guide ---
...
LEX_BOT_NAME = "telco-qconnect-bot-v2"
...
AI_AGENT_VOICE_PROMPT = "connect_ai_agents/telco-selfservice-voice/prompts/telco-selfservice-orchestration-voice.yaml"
AI_AGENT_VOICE_MODEL = "global.anthropic.claude-haiku-4-5-20251001-v1:0"
AI_AGENT_CHAT_PROMPT = "connect_ai_agents/telco-selfservice-chat/prompts/telco-selfservice-orchestration-chat.yaml"
AI_AGENT_CHAT_MODEL = "global.anthropic.claude-haiku-4-5-20251001-v1:0"
AI_AGENT_ASSIST_PROMPT = "connect_ai_agents/telco-agent-assist-es/prompts/telco-agent-assist-orchestration-es.yaml"
...
# ANDs industry=telco with this language so a Spanish agent never retrieves the
...
# ========================================================================== #
FLOW_SCREENPOP = "flows/telco-agent-screenpop-es/flow.json"
FLOW_ESCALATE_MODULE = "flows/escalate-to-agent/flow.json"
FLOW_INBOUND = "flows/telco-selfservice-es-inbound/flow.json"
# Module that classifies the contact endpoint, looks the customer up via the
# ai-session-telco Lambda, and writes the record into the Q in Connect session.
FLOW_SET_CUSTOMER_SESSION = "flows/set-customer-session-telco/flow.json"
...
ESCALATION_HANDOFF_VIEW_NAME = "TelcoEscalationHandoff"
ESCALATION_HANDOFF_VIEW_CONTENT = "views/telco-escalation-handoff/view-content.json"

# ========================================================================== #
# PHASE 6 — CX-TELCO-WEBSITE (WebsiteStack)
# Static "Latam Telco" site: Vite build (website/dist) → private S3 + CloudFront
...
KB_CONTENT_TAGS = {"industry": "telco"}
