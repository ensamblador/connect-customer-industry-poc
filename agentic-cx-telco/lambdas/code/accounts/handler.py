"""
Telco accounts Lambda handler.

Backs the /accounts endpoints of the telco self-service REST API:
...
lookup uses the GSI in env ACCOUNTS_PHONE_INDEX. Read-only; no PII is logged.
"""
