...
class Webhosting(Construct):
    ...
    def _create_data_viewer_origin(self) -> "origins.RestApiOrigin":
        ...
        The Lambda scans the three airline tables (accounts/products/cards) and
        ...
        Phase 1 (CX-AIRLINE-MCP); deploy that stack first.
        """
        stack = Stack.of(self)
        table_names = [
        ...
        fn = _lambda.Function(
            ...
            description="Renders the airline demo DynamoDB tables as an HTML page.",
        )
        ...
        api = apigateway.LambdaRestApi(
            ...
            description="Demo data viewer for the airline DynamoDB tables.",
        )
