...
deploy order (see app.py):
    ...
    Phase 2  CX-AIRLINE-KB              KnowledgeBaseStack
    Phase 3  CX-AIRLINE-CONNECT-SUPPORT ConnectSupportStack
    Phase 4  CX-AIRLINE-AGENTS          AiAgentsStack
    Phase 5  CX-AIRLINE-FLOWS           ContactFlowsStack
    Phase 6  CX-AIRLINE-WEBSITE         WebsiteStack
...
This project re-themes the shared reference architecture for an airline: the
...
AI_AGENT_MCP_TARGET = "airline-rest-api-oas-target"
...
KB_ENTRIES_DIR = "knowledge_bases/airline/entries"
# Logical S3 path prefix for the uploaded entries (organizational only — the
# DataIntegration SourceURI is the whole bucket): airline/es/..., airline/pt/..., etc.
KB_BUCKET_PREFIX = "airline"
...
AI_AGENT_SECURITY_PROFILE_NAME = "airline-selfservice-ai-agent"
...
AI_AGENT_ASSIST_SECURITY_PROFILE_NAME = "airline-agent-assist-iac"
...
# resolve its ARN by name. (The CARD_GUIDE_* constant names are retained from the
# sibling projects for structural parity; here the guide covers "maleta perdida".)
GUIDE_VIEW_NAME = "AirlineLostBaggageGuide"
GUIDE_VIEW_CONTENT = "views/airline-lost-baggage-guide/view-content.json"
FLOW_GUIDE = "flows/airline-lost-baggage-guide-es/flow.json"
...
GUIDE_FLOW_NAME = "Reportar maleta perdida"
...
LEX_BOT_NAME = "airline-qconnect-bot-v2"
...
AI_AGENT_CHAT_PROMPT = "connect_ai_agents/airline-selfservice-chat/prompts/airline-selfservice-orchestration-chat.yaml"
AI_AGENT_CHAT_MODEL = "global.anthropic.claude-haiku-4-5-20251001-v1:0"
AI_AGENT_ASSIST_PROMPT = "connect_ai_agents/airline-agent-assist-es/prompts/airline-agent-assist-orchestration-es.yaml"
...
# ANDs industry=airline with this language so a Spanish agent never retrieves the
...
# ========================================================================== #
FLOW_SCREENPOP = "flows/airline-agent-screenpop-es/flow.json"
FLOW_ESCALATE_MODULE = "flows/airline-escalate-to-agent/flow.json"
FLOW_INBOUND = "flows/airline-selfservice-es-inbound/flow.json"
# Module that classifies the contact endpoint, looks the customer up via the
# ai-session-airline Lambda, and writes the record into the Q in Connect session.
FLOW_SET_CUSTOMER_SESSION = "flows/set-customer-session-airline/flow.json"
...
ESCALATION_HANDOFF_VIEW_NAME = "AirlineEscalationHandoff"
ESCALATION_HANDOFF_VIEW_CONTENT = "views/airline-escalation-handoff/view-content.json"

# ========================================================================== #
# PHASE 6 — CX-AIRLINE-WEBSITE (WebsiteStack)
# Static "AeroLatam" site: Vite build (website/dist) → private S3 + CloudFront
...
# ========================================================================== #
# knowledge_bases/associate_guide.py finds the lost-baggage KB
...
KB_CONTENT_TAGS = {"industry": "airline"}
