#!/usr/bin/env python3
"""CDK app entry point for the agentic-cx-airline sample.
...
Phases (added incrementally):
    ...
    6. WebsiteStack        — static "AeroLatam" site (S3 + CloudFront, independent)
"""
...
# Phase 6 — static "AeroLatam" website (S3 private + CloudFront OAC). Hosts
