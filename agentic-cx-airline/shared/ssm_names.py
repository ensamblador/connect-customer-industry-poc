"""shared/ssm_names.py — the cross-stack SSM contract for agentic-cx-airline.
...
Names are plain ``String`` params under the ``/agentic-cx-airline/<phase>/<key>``
...
# lives OUTSIDE the /agentic-cx-airline namespace because CX-LANG-UTILS owns it;
